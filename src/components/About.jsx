...
const About = () => {
  return (
    <div className="mx-5 mt-36 flex justify-center gap-56">
      <img className="rounded-full w-96" src="/document.jpeg" alt="protfolio" />
      <div className="flex flex-col justify-center items-center">
        <div className="font-semibold">
          <p className="text-xl text-gray-600 my-2">Hello I'm</p>
          <h1 className="text-4xl my-2">K P Ramanath</h1>
